...
namespace v4Models.Tests
{
    public class ProcessSchemaTests
    {
        ...
        public void Should_construct_object_from_atrributes()
        {
            ...
            var actors = new List<v5Schemas.Schemas.Actor>();

            // Act
            var processSchema = new v5Schemas.Schemas.ProcessSchema(id, title, owner, purpose);
        ...
        {
            // Arrange
            var processSchema = new v5Schemas.Schemas.ProcessSchema();

            // Act
            var str = processSchema.ToString();

            var createdProcessSchema = JsonConvert.DeserializeObject<v5Schemas.Schemas.ProcessSchema>(str);
        ...
        public void Should_construct_object_from_schema()
        {
            ...
            // Act 
            var schema = new v5Schemas.Schemas.ProcessSchema(str);
        ...
        public void Should_Build_Correctly_From_v1_schema()
        {
            ...
            // Act
            var v4Process = new v5Schemas.Schemas.ProcessSchema(v1ProcessString);
        ...
        public void Should_Build_Correctly_From_v2_schema()
        {
            ...
            // Act
            var v4Process = new v5Schemas.Schemas.ProcessSchema(v2ProcessesStrimg);
        ...
        public void Should_Build_Correctly_From_v3_schema()
        {
            ...
            // Act
            var v4Process = new v5Schemas.Schemas.ProcessSchema(v3ProcessesStrimg);
        ...
        public void Should_Build_Correctly_From_v4_schema()
        {
            ...
            // Act
            var v5Process = new v5Schemas.Schemas.ProcessSchema(v4ProcessesStrimg);
        ...
        public void Should_Build_Correctly_From_v4_schema_with_actors()
        {
            // Arrange
            var v4Processes = new v4Schemas.Schemas.ProcessSchema("id-3", "title-3", "owner-3", "purpose-3");
            v4Processes.Actors = new List<Actor>() { new Actor() { Name = "bob", Age = "13" } };
            var v4ProcessesStrimg = JsonConvert.SerializeObject(v4Processes);
            ...
            Assert.True(v5Process.Version == v4Processes.Version);
            Assert.True(v5Process.Purpose == v4Processes.Purpose);
            Assert.True(v5Process.ActorCollection.Count == 1);
            Assert.True(v5Process.ActorCollection[0].Name == "bob");
            Assert.True(v5Process.ActorCollection[0].Age == "13");
        }
        ...
        public void Should_make_sure_list_is_created_correctly()
        {
            ...
            var actors = new List<v5Schemas.Schemas.Actor>();
            actors.Add(new v5Schemas.Schemas.Actor() { Age = "11", Name = "Roddy" });
            actors.Add(new v5Schemas.Schemas.Actor() { Age = "8", Name = "Lawson" });
            ...
            Assert.True(processSchema.ActorCollection[0].Name == "Roddy");
            Assert.True(processSchema.ActorCollection[1].Name == "Lawson");
            Assert.True(processSchema.ActorCollection[0].Age == "11");
            Assert.True(processSchema.ActorCollection[1].Age == "8");
